...
export const SearchBar: FC = () => {
    const { searchText, setSearchText, searchFilters, removeSearchFilter, clearSearchFilters } = useContext(ResultsContext);
    ...
    return <div className="p-4">
        <label className="input input-bordered flex items-center gap-2">
            ...
            {
                searchText &&
                <button className="btn btn-circle btn-outline btn-sm" disabled={!searchText} onClick={() => setSearchText('')}>
