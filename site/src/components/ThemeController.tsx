...
export const ThemeController: FC = () => {
    ...
    const handleThemeChange = useCallback(() => {
        ...
        setTheme(newTheme);
        localStorage.setItem(StorageKeyConstants.IS_DARK_THEME, JSON.stringify(newTheme === Theme.DARK));
    }, [setTheme, theme])

    return <label className="swap swap-rotate btn-ghost btn">
        <input type="checkbox" className="theme-controller" value={theme} checked={theme === Theme.DARK} onChange={handleThemeChange} />
